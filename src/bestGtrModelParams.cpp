...
bestGtrModel::bestGtrModel(tree& et, // find best Gtr Model Params
	...
	for (int i=0; i < maxTotalIterations; ++i) {
		...
		if(optimizeTree)
		{
			bblEM bblEM1(et,sc, sctm,sp,weights,maxBBLIt,epsilonLoglikeForBBL);
