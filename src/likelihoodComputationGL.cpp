...
{	
	...
	likelihoodComputationGL::fillPijAndUp(tr,sc,sctm,spVVec,distGain,distLoss,pi_vec,ssc_vec,cup_vec);
...
{	
	...
	for (int rateIndex=0 ; rateIndex<numOfRateCategories; ++rateIndex){		
		...
		//ComputeUp
		cup_vec[rateIndex].fillComputeUp(copy_et,sc,sctm,pi_vec[rateIndex],ssc_vec[rateIndex]);
	}
}
...
*********************************************************************************************/
//doubleRepMantisa likelihoodComputationGL::getLofPos(const int pos,
//										   const tree& tr,
//										   const sequenceContainer& sc,
