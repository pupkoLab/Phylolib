...
//make sure 0.5<=mantissa<1.0, as a matter of convention
...
MDOUBLE convert(const doubleRepMantisa& a){
	MDOUBLE aFullRep= ldexp(a._mantissa,a._expon); //Returns the result of multiplying x (the significand) by 2 raised to the power of exp (the exponent)
	return aFullRep;
}
