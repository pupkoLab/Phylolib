...
void tree::TreeNode::claimSons(){ // pass on all kids and let them know that I am their father
...
// OTU = leaf
// EPR - need to revise this method to be efficient. Pyramid from the leaves up to this node.
*********************************************************************************************/
