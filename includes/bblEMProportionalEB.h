...
private:
	...
	void addCountsPropEB(const int gene,const int pos, tree::nodeP mynode, const vector<doubleRepMantisa>& posProb, const MDOUBLE weig);
	...
	vector<vector< vector<doubleRepMantisa> > > _posLike;//[gene][pos][globalRateCategory]
