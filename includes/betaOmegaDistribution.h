...
public:
	...
	virtual const size_t categories() const {return _betaDistr.categories()+1;}
	virtual const MDOUBLE rates(const size_t i) const;
	virtual const MDOUBLE ratesProb(const size_t i) const;
