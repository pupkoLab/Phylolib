...
public:
	...
	const size_t alphabetSize() const {return _pijAccelerator->alphabetSize();} // The alphabet size is the same as the matrix Pij size

	virtual const size_t categories() const {return _distr->categories();}
