...
public:
	...
	static MDOUBLE rand_exp(const MDOUBLE mean) {// bug fixed by TalP 24/9/2022
		//return - mean * log(giveRandomNumberBetweenZeroAndEntry(1.0));
		return -log(giveRandomNumberBetweenZeroAndEntry(1.0))/ mean;//pg 64: Ross, Simulatio//pg 64: Ross, Simulation 2nd.
	}
